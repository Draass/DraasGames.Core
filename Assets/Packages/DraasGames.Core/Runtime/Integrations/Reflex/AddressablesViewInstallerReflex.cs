...
{
    public class AddressablesViewInstallerReflex : MonoBehaviour, IInstaller
    {
        ...
        public void InstallBindings(ContainerBuilder builder)
        {
            ...
            builder.RegisterValue(
                _viewContainer,
                new[] { typeof(AddressablesViewContainer), typeof(IViewAssetReferenceProvider) });

            builder.RegisterType(
                typeof(AddressablesViewProvider),
